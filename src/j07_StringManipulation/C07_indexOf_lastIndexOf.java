...
*/
        ...
        System.out.println(str.indexOf("q"));// -1 verir çünkü olmayan karakter için -1 return eder.q olmadığı için

        //biden çok karakter veya strin için soldan sağa ilk okunan değerin indexini verir.
        ...
        System.out.println(str.indexOf("a", 13)); // a karakterinini 13 üncü indeksten sonraki a yı getirir.-->17



        /*Girilen bir string ifadenini aşağıdaki şartları sağlamasısn kontrol eden kod create edin
            1.  girilen ifade java içermiiyor.
            1.  girilen ifade 1 adet java içeriyor.
            1.  girilen ifade 1 den çok java içeriyor.
        ...
        if (str.indexOf("java") == -1) { // java yoksa indedks -1 dir. java yokluk kontrolü
            System.out.println("Java içeriği bulunamadı");

        } else if (str.indexOf("java") == str.lastIndexOf("java")) { // girilen ifadede java 1 tane var

        } else System.out.println("Girilen ifadede birden çok java vardır");
    }
