 ...
 */
        ...
        System.out.println("str.replace(\"a\", \"*\") = " + str.replace("a", "*")); //J*v*c*nl*r* Sel*m bolc*n* offer :
        System.out.println(str); // Javacanlara Selam bolcana offer :


        System.out.println(str.replaceFirst("a", ":)")); // ilk a karakterini :) ile değiştirir.
...
// kart no : **** **** **** 1234
        ...
        String yeniAd = name.charAt(0) + name.substring(1).replaceAll("\\w", "*");
        String yeniSoyad = surname.charAt(0) + surname.substring(1).replaceAll("\\w", "*");
        String yeniKK = "**** **** **** **** " +kartNo.substring(12);
        System.out.println(yeniAd + " " + yeniSoyad );
        System.out.println(yeniKK);
