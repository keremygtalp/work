...
public class C08_equals_equalsIgnoreCase {
    ...
    public static void main(String[] args) {
        ...
        String s1="clarusway";// string havuzundan bir variable. gömlek cebinden çıkan para
        String s2="clarusway"; //string havuzundan bir variable. gömlek cebinden çıkan para
        String s3=new String("clarusway"); // string data type obj. non primitive cüzdan
        String s4=new String("clarusway"); // string data type obj. non primitive cüzdan

        System.out.println(s1==s2 ); // true çünkü s1 ve s2 aynı string pooldan (ref değeri aynı)
        System.out.println("s1.equals(s2) = " + s1.equals(s2));//true equals sadece value baktığı için
        System.out.println("s3==s4 = " + s3 == s4);// false herseyine bakar
        System.out.println("s3.equals(s4) = " + s3.equals(s4));// true // degerine bakar
